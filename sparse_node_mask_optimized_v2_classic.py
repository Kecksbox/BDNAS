...
class Network:
    ...
    def sample_topologie(self):
        ...
        while True:
            ...
            input_nodes_alive_layer, input_nodes_alive_full = reduce_connection_mask_matrix_operation(connection_mask_matrix, self.input_layer.dim_in)
    ...
    def __call__(self, input_batch, sequence, *args, **kwargs):
        ...
        activation = SparseRowMatrix(dense_shape=[first_hidden_layer_weights.dense_shape[1] - num_input_nodes, input.shape[1]])
