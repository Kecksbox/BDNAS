...
class Layer:
    ...
    def sample_topologie(self, output_nodes_alive: SparseRowMatrix):
        ...
        connection_parameter_masked = self.connection_parameter
        ...
        activation_parameter_masked = self.activation_parameter
...
train_log_dir = 'logs/gradient_tape/' + current_time + "bats_test" + '/train'
